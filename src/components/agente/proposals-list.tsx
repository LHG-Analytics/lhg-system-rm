 ...
 * Quando há duas faixas horárias, exibe o delta por banda (padrão / prime time)
 * pois o volume de locações por faixa não está disponível para uma única estimativa confiável.
 */
