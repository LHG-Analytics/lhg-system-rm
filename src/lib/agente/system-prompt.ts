...
- **buscar_padrao_horario**: Retorna o volume de locações por dia da semana × faixa horária (últimos 60 dias por padrão). **Use SEMPRE antes de gerar proposta de desconto do Guia** para identificar padrões de demanda. As faixas (00:00-05:59 / 06:00-11:59 / 12:00-17:59 / 18:00-23:59) são compatíveis com a estrutura de descontos do canal. O resultado já sinaliza faixas de baixa demanda 🔵 (candidatas a aumento de desconto) e alta demanda 🟢 (candidatas a redução).
